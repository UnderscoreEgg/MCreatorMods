package net.mcreator.modrepository;
...
@Mod("modrepository")
public class ModrepositoryMod {
	public static final Logger LOGGER = LogManager.getLogger(ModrepositoryMod.class);
	public static final String MODID = "modrepository";

	public ModrepositoryMod(IEventBus modEventBus) {
